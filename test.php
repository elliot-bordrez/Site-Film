...
< corps >
    ...
    < div  class =" affiche " >
        ...
        <?php
        if ($BasePDO){}
        $req = "SELECT * FROM MEDECIN ORDER BY idMedecin DESC";
                                ...
                                ?>
                                    <td colspan="4">
                                        <form action="" method="post">
                                            ...
                                            <input type="text" name="MedecinNom" alue="<?php echo $Tab[1]?>" autofocus class="input">
                                            <input type="text" name="MedecinPrenom" alue="<?php echo $Tab[2]?>" autofocus class="input">
                                            <input type="submit" name="MedecinUpdate2Submit" value="Valider" class="btnUpdate2">
                                         </form>
                                     </td>
                                <?php
                            }else{
                                ...
                                ?>
                                    ...
                                    <td>
                                        <form actions="" method="post">
                                            <input type="hidden" name="idUpdate" value="<?php echo $Tab[0]?>">
                                            <input type="submit" name="MedecinUpdateSubmit" value="modifier" class="btnUpdate">
                                        </form>
                                    </td>
                                <?php
                            }
